...
<?php
	...
	$registro = $conecta->prepare("SELECT * FROM noticia_evento WHERE palavra_chave like ? and idtipo_noticia = 1");
	...
	$registro -> bindValue (1, "%" .$palavra_chave. "%");
		...
		else echo "<script> alert('Noticia não encontrada!!!');window.location='noticia.php';</script>";
		}
?>
