...
$tinybrowser['path']['image'] = '/Cash/uploads/images/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = '/Cash/uploads/media/'; // Media files location
$tinybrowser['path']['file']  = '/Cash/uploads/files/'; // Other files location
